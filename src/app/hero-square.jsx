export default function HeroSquare() {
  return (
    <div className="flex flex-col justify-between p-6 row-span-3 col-span-3 bg-white rounded-4xl">
      <h1 className="text-4xl font-semibold text-gray-800 leading-tight">Votre Agence Web à La Rochelle</h1>
