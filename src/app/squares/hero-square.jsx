...
export default function HeroSquare() {
  return (
    <div className="flex flex-col justify-between px-9 py-8 row-span-3 col-span-5 bg-[#faf9f6] rounded-[50px]">
      <h1 className={`${gabarito.className} h1 text-5xl`}>Votre Agence Web à La Rochelle</h1>
